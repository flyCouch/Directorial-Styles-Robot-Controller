...
class robotDirector:
    ...
    def read_keyboard(self, event):
        ...
        if self.current_control_method == "Direct X/Y/R Buttons":
            ...
            if keysym == 'w':
                ...
                return # This return needs to be here, at the same indentation level as the 'if/elif' block
            ...
            #else: # No need for this else block if you're just commenting out the print
    ...
    def _process_next_gcode_command(self):
        ...
        if match_g1_g0:
            ...
            MM_TO_M_SCALE = .0007 # Corrected: 1 millimeter = 0.001 meters
    ...
    def send_control_command(self):
        ...
        try:
            ...
            # --- ADD THIS LINE: Small delay to prevent serial buffer overflow on Arduino ---
            time.sleep(0.1) # 10ms delay. You might need to adjust this (e.g., 0.005 to 0.05)
